...
\begin{english}[variant = american]
	\begin{abstract}
		...
		tight upper bounds of their runtime since they do not suffer from external fragmentation. This increases
		predictability, which is beneficial in an embedded real-time Java environment.

		Besides memory management, the thesis discusses other usage possibilities of escape analysis results, such as
