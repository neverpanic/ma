...
\chapter{Introduction}
	...
	\section{Previous Work}
		...
		\todonote{Recall what my bachelor thesis was about. Outline why escape analysis (or alias analysis in general) can
		not be as precise as it is in type-safe languages in the presence of pointers.}
