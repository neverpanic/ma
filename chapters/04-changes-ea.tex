	...
	\section{Improvements}
		...
		\subsection{Fixing Incorrect Results: The Double Return Bug}
			...
			\begin{table}
				...
				\end{tabular}
				\caption[The \emph{mapsToObj} relation for the call of \emph{chooseOne} from \emph{getObject}]{%
					The \emph{mapsToObj} relation for the call of \emph{chooseOne} from \emph{getObject} as given
			...
			in~\cref{tbl:ea:improve:bug:mapsTo}. If \emph{chooseOne(ret)} did not yet have any pointees at this point of the
			...
			but also between reference nodes in a new relation called \emph{mapsToRef}.
		...
		\subsection{Interprocedural Analysis Optimizations} \label{subsec:ea:improve:opt}
