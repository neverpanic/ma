...
\chapter{Escape Analysis}
	...
	and~\cite{choi:03:toplas}. \Cref{sec:ea:improvements} lists and explains the improvements written for this thesis.
				...
				\Begin{%
					...
					\While{$\workList \ne \emptyset \;\mathrm{or}\; \needsPointee \ne \emptyset$}{%
						\While{$\workList \ne \emptyset$}{%
							...
							\eIf{$\xPointees \;\hat{=}\; \emptyset \;\mathrm{or}\; \yPointees \ne \emptyset$}{%
						...
						\While{$\workList \;\hat{=}\; \emptyset \;\mathrm{and}\; \needsPointee \ne \emptyset$}{%
