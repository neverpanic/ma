...
\chapter{Evaluation}
	...
	\section{Runtime Results}
		...
		improvements:~\Cref{fig:eval:rt:time:ea} contains the runtimes of three configurations relative to the baseline
		...
		analysis. While the changes implemented for this thesis achieve a lower percentage of \emph{local} objects that are
		candidates for the optimizations, the runtime results are considerably improved: Runtime is reduced by up to 9.5
